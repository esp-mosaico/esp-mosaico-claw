...
export const zhCn: Dict = {
  ...
  asrSection: 'AI Create 语音识别',
  asrPresets: 'ASR 预置配置',
  asrProviderQwen: 'Qwen',
  asrProviderTrial: 'Trial',
  asrValidationRequiredFields: '保存前请补全 ASR 必填项：{fields}。',
  asrProvider: 'ASR 提供商',
  asrApiKey: 'ASR API 密钥（留空则禁用）',
  asrWorkspace: 'Workspace ID（可选）',
  asrLanguage: '语言提示',
  asrModel: 'ASR 模型',
  asrEndpoint: 'ASR WebSocket 地址',
