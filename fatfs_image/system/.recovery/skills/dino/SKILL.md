...
- Display touch registered as `lcd_touch`, or a GPIO button passed through `button_gpio`.
...
Press the display or the configured button to jump; after game over, press again to
