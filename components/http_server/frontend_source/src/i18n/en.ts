export const en = {
  ...
  llmProviderTrial: 'Trial (OpenAI + Qwen)',
  ...
  asrSection: 'AI Create Speech Recognition',
  asrPresets: 'ASR Presets',
  asrProviderQwen: 'Qwen',
  asrProviderTrial: 'Trial',
  asrValidationRequiredFields: 'Complete required ASR fields before saving: {fields}.',
  asrProvider: 'ASR Provider',
  asrApiKey: 'ASR API Key (leave empty to disable)',
  asrWorkspace: 'Workspace ID (optional)',
  asrLanguage: 'Language Hint',
  asrModel: 'ASR Model',
  asrEndpoint: 'ASR WebSocket Endpoint',
