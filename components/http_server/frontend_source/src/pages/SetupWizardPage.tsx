...
function providerLabel(key: ProviderKey): string {
  switch (key) {
    ...
    case 'trial':
      return t('llmProviderTrial') as string;
  }
}
...
export const SetupWizardPage: Component<SetupWizardPageProps> = (props) => {
  ...
  const saveLlm = async () => {
    ...
    if (llmForm.llm_backend_type !== 'trial') {
      requiredFields.unshift([llmForm.llm_api_key, t('llmApiKey') as string]);
    }
          ...
          <div class="grid gap-4 sm:grid-cols-2">
            ...
            <TextInput
              ...
              label={
                <>
                  {t('feishuAppSecret')}
                  <LabelLink href={IM_CREDENTIAL_URLS.feishu}>
                    {t('imGetCredentials') as string} ↗
                  </LabelLink>
                </>
              }
          ...
          <div class="grid gap-4 sm:grid-cols-2">
            ...
            <TextInput
              ...
              label={
                <>
                  {t('qqAppSecret')}
                  <LabelLink href={IM_CREDENTIAL_URLS.qq}>
                    {t('imGetCredentials') as string} ↗
                  </LabelLink>
                </>
              }
          ...
          <div class="grid gap-4 sm:grid-cols-2">
            <TextInput
              ...
              label={
                <>
                  {t('tgBotToken')}
                  <LabelLink href={IM_CREDENTIAL_URLS.telegram}>
                    {t('imGetCredentials') as string} ↗
                  </LabelLink>
                </>
              }
