...
static EXT_RAM_BSS_ATTR httpd_handle_t      s_httpd;
static EXT_RAM_BSS_ATTR SemaphoreHandle_t   s_ws_mx;
static EXT_RAM_BSS_ATTR int s_ws_fds[WEBIM_WS_MAX_CLIENTS];
static EXT_RAM_BSS_ATTR size_t              s_ws_count;
static EXT_RAM_BSS_ATTR uint32_t            s_evt_seq;
static EXT_RAM_BSS_ATTR bool                s_webim_bound;
